...
Jindong (진동) is the Korean word for "vibration". We chose this name to reflect the library's core purpose while embracing the Korean heritage of its creators.
</Callout>
