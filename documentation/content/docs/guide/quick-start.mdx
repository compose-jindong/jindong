...
<Callout type="info">
This guide covers the **Compose API** (`jindong-compose` module). For non-Compose usage, see [Core API Guide](/docs/api/core-api).
</Callout>
...
- [Composable DSL](/docs/api/jindong-compose/composable-dsl/haptic) - All DSL primitives
- [HapticIntensity](/docs/api/jindong-core/haptic-intensity) - Intensity options
