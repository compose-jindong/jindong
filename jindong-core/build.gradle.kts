...
kotlin {
  androidLibrary {
    namespace = "io.github.compose.jindong.core"
...
mavenPublishing {
  ...
  coordinates(group.toString(), "jindong-core", version.toString())

  pom {
    name = "Jindong Core"
    description = "Core module for Jindong - Declarative Haptic Feedback Library for Kotlin Multiplatform"
    inceptionYear = "2026"
